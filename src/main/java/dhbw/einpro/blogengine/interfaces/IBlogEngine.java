...
public interface IBlogEngine
{
    ...
    /**
     * Fügt einen neuen Benutzer zum Blog-System
     * 
     ...
     *                                 oder wenn ein Benutzer mit der gleichen Email-Adresse bereits im Blog-System existiert.
     */
     ...
     *               ersten Post zum Blog-System hinzufügen, dann bekommt der Post
     *               die Id 1. Der zweite Post bekommt die Id 2 und alle weiteren
     *               Posts bekommen aufsteigende Nummern.
     * @return Id des neu hinzugefügten Posts.
     * @throws UserNotFoundException wird ausgelöst, falls der Author des Posts nicht als
     *                                   Benutzer im Blog-Systems registriert ist oder wenn der Autor eines
     *                                   Kommentars des Posts nicht als Benutzer im Blog-System registriert ist.
     */
    ...
    /**
     * Liefert alle Posts zu einem gesuchten Titel.
     * 
     * @param title Titel der gesuchten Posts
